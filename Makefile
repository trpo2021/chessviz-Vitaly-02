...
$(TEST_OBJ)move_rule_for_king.o: $(LIBCHESSVIZ_SRC)move_rule_for_king.cpp
	$(CXX) -c $(CPPFLAGS) -o $@ $<
	
$(TEST_OBJ)move_rule_for_knight.o: $(LIBCHESSVIZ_SRC)move_rule_for_knight.cpp
	$(CXX) -c $(CPPFLAGS) -o $@ $<
	
$(TEST_OBJ)move_rule_for_queen.o: $(LIBCHESSVIZ_SRC)move_rule_for_queen.cpp
	$(CXX) -c $(CPPFLAGS) -o $@ $<
	
$(TEST_OBJ)move_rule_for_rook.o: $(LIBCHESSVIZ_SRC)move_rule_for_rook.cpp
	$(CXX) -c $(CPPFLAGS) -o $@ $<

.PHONY: clean-test
clean-test:
	rm $(CHESSVIZ_BIN)test
	find $(TEST_OBJ) -name '*.o' -exec $(RM) '{}' \;
	find $(TEST_OBJ) -name '*.a' -exec $(RM) '{}' \;
